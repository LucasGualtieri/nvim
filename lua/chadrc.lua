...
M.base_30 = {
	...
	blue = "#569CD6",
	dark_blue = "#0c70f2",
	constant_blue = "#4FC1FF",
	nord_blue = "#60a6e0",
	yellow = "#D7BA7D",
	sun = "#e1c487",
	purple = "#c68aee",
	dark_purple = "#b77bdf",
	vscode_repeat = "#C586C0",
	teal = "#4294D6",
	orange = "#d3967d",
	cyan = "#9CDCFE",
...
M.ui = {
	...
	hl_override = {
		...
		["@constant.builtin"] = { fg = M.base_30.constant_blue },
		["@variable.parameter"] = { fg = M.base_30.cyan },
		["@punctuation.bracket"] = { fg = M.base_30.white },
		["@constant"] = { fg = M.base_30.constant_blue },
		["@keyword.exception"] = { fg = M.base_30.blue },
		["@keyword.repeat"] = { fg = M.base_30.vscode_repeat },
